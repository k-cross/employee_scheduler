...
#       User friendliness: Use GUI or HTML5 instead of direct CSV input and cli
#       Multi-Shift Support: Run multiple-times for different shifts, which may also require
